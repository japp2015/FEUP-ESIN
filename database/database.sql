CREATE TABLE personnel (
    ...
    e-mail VARCHAR(320) NOT NULL, -- 64 characters for local part + @ + 255 for domain name
...
CREATE TABLE works (
    ...
    PRIMARY KEY (id_personnel, id_occurrence)
);
...
INSERT INTO personnel (username, password, e-mail, fullname, gender, birthdate, naturality, star_service, school, position, station) VALUES ('japp', 'feup2015', 'joao@gmail.com', 'João Afonso Pereira', 'Masculino', '1997-12-06', 'Portuguesa','2016-02-11', 'Escola Prática de Polícia', 'Diretor Nacional', 'Porto');
INSERT INTO personnel (username, password, e-mail, fullname, gender, birthdate, naturality, star_service, school, position, station) VALUES ('mariajmribeiro', 'feup2015', 'maria@gmail.com', 'Maria João Ribeiro', 'Feminino', '1997-11-02', 'Portuguesa','2016-02-11', 'Escola Prática de Polícia', 'Chefe de Esquadra','Porto');
INSERT INTO personnel (username, password, e-mail, fullname, gender, birthdate, naturality, star_service, school, position, station) VALUES ('patricia', 'feup2015', 'patricia@gmail.com', 'Patricia Rocha', 'Feminino', '1997-08-20', 'Portuguesa','2016-02-11', 'Escola Prática de Polícia', 'Detetive', 'Porto');

INSERT INTO occurrence (id, type, title, chief_detective, state, oppening_date, location, description) VALUES (NULL, 'Homicídio', 'Morreu em Salgueiros' ,'patricia', 'Aberto', '2017-02-11','Salgueiro','Ontem morreu um homem em Salgueiros');